  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {/* 통화 카드 */}
        <div
          className="bg-cp-card bg-gradient-to-br from-cp-card to-cp-bg border border-cp-border p-6 shadow-lg hover:shadow-xl hover:border-teal-500/50 transition-all cursor-pointer rounded-sm flex items-center"
          onClick={() => {
        ...
        >
          <div className="flex items-center gap-4 w-full">
            <div className="w-14 h-14 rounded-sm flex items-center justify-center flex-shrink-0 bg-cp-bg/50 border border-cp-border">
              <svg
            ...
            <div className="flex-1 min-w-0 ml-8">
              ...
              <div className="text-sm text-cp-muted mb-1">오늘 성공률</div>
        ...
        {/* 위험 카드 */}
        <div
          className="bg-cp-card bg-gradient-to-br from-cp-card to-cp-bg border border-cp-border p-6 shadow-lg hover:shadow-xl hover:border-red-500/50 transition-all cursor-pointer rounded-sm flex items-center"
              ...
              if (item.type === "patient") {
                ...
                return (
                  <div
                    ...
                    className="bg-cp-bg/30 rounded-sm p-4 border border-cp-border"
                  >
                      ...
                      <div className="flex items-center gap-4 flex-shrink-0">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="text-sm text-cp-text hover:text-teal-400"
                          >
                            [상세보기]
                          </button>
                          <button
        ...
        <div className="bg-cp-card bg-gradient-to-br from-cp-card to-cp-bg border border-cp-border rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow min-h-[400px] flex flex-col">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-cp-bg border border-teal-400/50 rounded text-teal-400 hover:border-teal-400 hover:bg-cp-card transition-colors"
            >
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <span
                      className={`text-sm flex-shrink-0 ${statusStr === "[완료됨✓]" ? "text-teal-400" : "text-cp-muted"}`}
                    >
                      {statusStr}
                    </span>
                  </div>
                ...
                const getStatusInfo = (status) => {
                  ...
                  switch (status.toUpperCase()) {
                    ...
                    default:
                      return {
                        text: status,
                        bgClass: "bg-cp-bg/90 border border-cp-border",
                        textClass: "text-cp-text",
                      };
                  }
                };
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        ...
                        <span className="text-sm text-cp-text whitespace-nowrap">
                          [최근 작업]:
                        </span>
                        <span className="text-sm text-cp-text truncate">
                          {task.title || "작업 제목 없음"}
                      ...
                      <div className="flex items-center gap-4 flex-shrink-0">
                        ...
                        <button
                          onClick={() => navigateToTask('WAITING,IN_PROGRESS')}
                          className="text-sm text-cp-text hover:text-teal-400 whitespace-nowrap"
                        >
                          [처리하기]
                        </button>
                      </div>
