                ...
                {isEditing ? (
                    <div className="mt-2">
                        ...
                        <div className="flex justify-end gap-2 mt-2">
                            <button onClick={() => setIsEditing(false)} className="text-xs px-2 py-1 bg-gray-200 rounded">취소</button>
                            <button onClick={handleUpdate} className="text-xs px-2 py-1 bg-blue-500 text-white rounded">저장</button>
                        </div>
                    </div>
                ) : (
                    <>
                        <p className={`text-sm mb-2 ${isDeleted ? "text-gray-400 italic" : "text-gray-700"}`}>
                            {comment.content}
                        </p>
                        {!isDeleted && (
                            <button
