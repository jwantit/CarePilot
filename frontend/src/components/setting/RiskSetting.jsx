    ...
    <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">위험 점수 임계값 설정</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <ThresholdInput
              ...
              onChange={(value) => handleThresholdChange('criticalThreshold', value)}
            ...
            <ThresholdInput
              ...
              onChange={(value) => handleThresholdChange('highThreshold', value)}
            ...
            <ThresholdInput
              ...
              onChange={(value) => handleThresholdChange('mediumThreshold', value)}
