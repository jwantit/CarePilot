    ...
    <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">알림 수신 방식</h2>
          <ToggleSwitch
          ...
          <ToggleSwitch
            ...
            onChange={(e) => handleConfigChange('kakaoEnabled', e.target.checked)}
            label="카카오톡 알림"
          />
        ...
        {/* 알림 유형 섹션 */}
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">알림 유형</h2>
          <ToggleSwitch
            checked={notificationConfig.riskDetectionEnabled}
            onChange={(e) => handleConfigChange('riskDetectionEnabled', e.target.checked)}
            label="위험 감지 알림"
          />

          <ToggleSwitch
            checked={notificationConfig.callFailureEnabled}
            onChange={(e) => handleConfigChange('callFailureEnabled', e.target.checked)}
            label="통화 실패 알림"
          />

          <ToggleSwitch
            checked={notificationConfig.emergencyEventEnabled}
            onChange={(e) => handleConfigChange('emergencyEventEnabled', e.target.checked)}
            label="긴급 상황 알림"
          />
        </div>
        ...
        {/* 알림 제한 시간 섹션 */}
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">알림 제한 시간</h2>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleConfigChange('nightRestrictionStart', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleConfigChange('nightRestrictionEnd', e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              />
            </div>
          </div>
